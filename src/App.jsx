...
USER: ${p.name || "User"}, Birthday: ${p.birthday || "?"}, Experience: ${p.experience || "?"}, Goals: ${(p.goals || []).join(", ") || "none"}, Focus: ${(p.bodyAreas || []).join(", ") || "none"}, Mind: ${(p.mindInterest || []).join(", ") || "none"}, Time: ${p.timeAvail || "?"}, When: ${p.timeOfDay || "?"}.
