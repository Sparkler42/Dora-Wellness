...
export const tiers = [
  {
    ...
    f: ["Daily intention & body scan", "3 guided sessions/week", "Basic awareness exercises", "Community forum", "Weekly tip from David & Caroline"],
  },
  {
  ...
  },
  {
    ...
    f: ["Everything in Deep, plus:", "1-on-1 with David or Caroline", "Movement assessment", "Custom bodywork guidance", "In-person sessions (Ukiah)", "Direct messaging", "Custom programming"],
  },
];
